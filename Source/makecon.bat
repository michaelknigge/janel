...
"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.com" Janel.sln /rebuild "Release Console|Win32"
copy ".\Release Console\Janel.exe" ..\Executables\Win32\JanelConsole32.exe

"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.com" Janel.sln /rebuild "Release Console|x64"
