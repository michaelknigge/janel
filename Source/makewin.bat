...
"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.com" Janel.sln /rebuild "Release Windows|Win32"
copy ".\Release Windows\Janel.exe" ..\Executables\Win32\JanelWindows32.exe

"C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.com" Janel.sln /rebuild "Release Windows|x64"
