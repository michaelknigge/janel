...
1.  Set environment variable ANT\_HOME to the root directory of your Ant installation.
2.  Set environment variable JAVA\_HOME to the root directory of your Java SDK (not JRE) installation.
